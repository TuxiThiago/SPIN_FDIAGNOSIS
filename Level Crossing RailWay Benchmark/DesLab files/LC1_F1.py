...
syms( 'x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 ap1 cr in1 kd lv1 lw or1 rs bf ig1' )
X = [x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19]
Sigma = [ap1,cr,in1,kd,lv1,lw,or1,rs,bf,ig1]
X0 = [x0]
Xm = []
...
print(is_diagnosable(G1,'ig1',[ap1,cr,in1,kd,lv1,lw,or1,rs],'Gv'))
