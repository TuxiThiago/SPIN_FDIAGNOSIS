/* Automatically generated file for diagnosability verification of failure of type 2 for 2 Trains*/
...
#define N 2
mtype = {cr,kd,lw,or,rs,bf,ap1,en1,lv1,ig1,ap2,en2,lv2,ig2,ig1n,ig2n}
bool F,T;
chan F2N = [0] of { mtype };
ltl L1 { <>[]!(F && T)};
...
p2=N; p6=N; p7 = 1; p11 =1; p21 =1; /* initial marking */
do
