/* Automatically generated file for diagnosability verification of failure of type 1 for 2 Trains*/
...
#define N 2
mtype = {cr,kd,lw,or,rs,bf,ap1,en1,lv1,ig1,ap2,en2,lv2,ig2,bfn}
bool F,T;
chan F2N = [0] of { mtype };
ltl L1 { <>[]!(F && T)};
