/* Automatically generated file for diagnosability verification of failure of type 1 for 11 Trains*/
...
#define N 11
mtype = {cr,kd,lw,or,rs,bf,ap1,en1,lv1,ig1,ap2,en2,lv2,ig2,ap3,en3,lv3,ig3,ap4,en4,lv4,ig4,ap5,en5,lv5,ig5,ap6,en6,lv6,ig6,ap7,en7,lv7,ig7,ap8,en8,lv8,ig8,ap9,en9,lv9,ig9,ap10,en10,lv10,ig10,ap11,en11,lv11,ig11,bfn}
bool F,T;
chan F2N = [0] of { mtype };
ltl L1 { <>[]!(F && T)};
...
p2=N; p6=N; p7 = 1; p11 =1; p21 =1; p31 =1; p41 =1; p51 =1; p61 =1; p71 =1; p81 =1; p91 =1; p101 =1; p111 =1; /* initial marking */
do
