/* Automatically generated file for diagnosability verification of failure of type 2 for 8 Trains*/
...
#define N 8
mtype = {cr,kd,lw,or,rs,bf,ap1,en1,lv1,ig1,ap2,en2,lv2,ig2,ap3,en3,lv3,ig3,ap4,en4,lv4,ig4,ap5,en5,lv5,ig5,ap6,en6,lv6,ig6,ap7,en7,lv7,ig7,ap8,en8,lv8,ig8,ig1n,ig2n,ig3n,ig4n,ig5n,ig6n,ig7n,ig8n}
bool F,T;
chan F2N = [0] of { mtype };
ltl L1 { <>[]!(F && T)};
...
p2=N; p6=N; p7 = 1; p11 =1; p21 =1; p31 =1; p41 =1; p51 =1; p61 =1; p71 =1; p81 =1; /* initial marking */
do
...
/*t44*/	:: atomic { d_step{inp1(p42)		-> out1(p43) ->T=1}	-> F2N!ig4	}
...
/*t54*/	:: atomic { d_step{inp1(p52)		-> out1(p53) ->T=1}	-> F2N!ig5	}
...
/*t64*/	:: atomic { d_step{inp1(p62)		-> out1(p63) ->T=1}	-> F2N!ig6	}
...
/*t74*/	:: atomic { d_step{inp1(p72)		-> out1(p73) ->T=1}	-> F2N!ig7	}
...
/*t84*/	:: atomic { d_step{inp1(p82)		-> out1(p83) ->T=1}	-> F2N!ig8	}
...
/*t44*/	:: atomic {F2N?ig4n -> d_step{inp1(p42)		-> out1(p43)} }
...
/*t54*/	:: atomic {F2N?ig5n -> d_step{inp1(p52)		-> out1(p53)} }
...
/*t64*/	:: atomic {F2N?ig6n -> d_step{inp1(p62)		-> out1(p63)} }
...
/*t74*/	:: atomic {F2N?ig7n -> d_step{inp1(p72)		-> out1(p73)} }
...
/*t84*/	:: atomic {F2N?ig8n -> d_step{inp1(p82)		-> out1(p83)} }
