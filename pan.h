...
#define _nstates2	14	/* L1 */
#define minseq2	86
#define maxseq2	98
#define _endstate2	13

#define _nstates1	51	/* Diag */
#define minseq1	36
#define maxseq1	85
#define _endstate1	50

#define _nstates0	37	/* TSF */
#define minseq0	0
#define maxseq0	35
...
#define PDiag	((P1 *)this)
typedef struct P1 { /* Diag */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
